...
status: completed
last_updated: "2026-06-12T14:27:43Z"
...
**Current focus:** Phase 6 / TP5 — Iluminación & Sombras (unified warm light). Plan 06-03 COMPLETE 2026-06-12 — TP5 per-material specular shipped: wood (roughness 0.42/clearcoat 0.68/clearcoatRoughness 0.25/envMapIntensity 0.50), body (0.52/0.44/0.35/0.4), card stock (roughness 0.60/clearcoatRoughness 0.50), card face (roughness 0.50), chip pre-dv (0.52/0.38/0.50/sheen 0.4); brass UNCHANGED (TP4-locked); M5 PASS 0%/0%, M7 PASS, M10=52 not regressed; M4 pre-existing fail (V=0.866, delta +0.003 from 06-03, pre-existing from Wave 0); deferred to 06-05. Next = 06-04 (green-bounce verification).
...
Status: ✅ TP4 shipped + TP5 Wave 0 grounding shipped + TP5 Wave 2 key reshaping shipped + TP5 Wave 3 per-material specular shipped (6/10 phases in-progress, plan 06-03/6 complete). Phase 6 / TP5 — 06-01 COMPLETE: SoftShadows PCSS unconditional in Scene; ContactShadows frames=1/opacity=0.35/color=#1a0e06/far=5/blur=2.0/scale=FELT_R*3.5; key spotLight shadow-normalBias=0.02/near=8/far=28; M6 PASS 21.03%; M10 improved 106→52; Commits 65d39c4+83ef5df. 06-02 COMPLETE 2026-06-12: KEY_TO_FILL_RATIO_CEILING=3.5; ?light= A/B flag (lightFlag=qp('light') in Scene; Lights lightFlag prop); shaped path: angle=0.72/intensity=2.2/fill=0.8/hemisphere ground #0d3d24 (2.75x ratio, PASS); base path: angle=0.62/intensity=2.0/fill=0.7/hemisphere ground #1a0f08 (2.86x ratio, PASS); rim: 0.22/0.26; M5 PASS (0%/0%); M7 PASS; M10=52 (not regressed); tsc src/lab/ clean; vitest 45/45; shaped verdict PASS. Captures: hero-shaped/hero-base/macro-shaped at tp5-gate/. Commits 11c082f+6f38366. 06-03 COMPLETE 2026-06-12: woodMat roughness 0.38->0.42/clearcoat 0.72->0.68/clearcoatRoughness 0.2->0.25/envMapIntensity 0.65->0.50; bodyMat 0.48->0.52/0.5->0.44/0.3->0.35/0.5->0.4; card stock roughness 0.62->0.60/clearcoatRoughness 0.55->0.50; card face roughness 0.52->0.50; chip pre-dv 0.5->0.52/0.42->0.38/0.46->0.50/sheen 0.5->0.4; brassMat UNCHANGED (TP4-locked); M5 PASS 0%/0%; M7 PASS; M10=52; M4 pre-existing fail (V=0.866, +0.003 from 06-03 noise, deferred to 06-05); vitest 45/45; tsc src/lab/ clean; Commits 884144c+d2ba85f. Next: 06-04 (green-bounce verification).
...
Last session: 2026-06-12T14:27:43Z
Stopped at: Plan 06-03 COMPLETE 2026-06-12 -- TP5 per-material specular shipped; wood/body/card/chip deltas in anti-casino direction; brass UNCHANGED; M5 PASS 0%/0%; M7 PASS; M10=52; M4 pre-existing fail deferred to 06-05; commits 884144c+d2ba85f.
Next: Phase 6 / TP5 -- 06-04 (green-bounce verification: capture ?cam=rail with/without ?light=base; confirm body volume top-lighter + underside warm-green; no green spotlight read on chip undersides). Do NOT auto-advance -- operator chooses when to proceed.
