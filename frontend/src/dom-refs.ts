...
export const dom = {
  ...
  yourBetStatus: getRef<HTMLSpanElement>("#your-bet-status"),
  yourChipsStatus: getRef<HTMLSpanElement>("#your-chips-status"),
  ...
  turnReason: getRef<HTMLSpanElement>("#turn-reason"),
